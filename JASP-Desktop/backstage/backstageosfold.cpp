...
BackstageOSFOld::BackstageOSFOld(QWidget *parent) : BackstagePage(parent)
{
...
void BackstageOSFOld::setOnlineDataManager(OnlineDataManager *odm)
{
	_odm = odm;
...
void BackstageOSFOld::attemptToConnect()
{
	_model->attemptToConnect();
}

void BackstageOSFOld::setCurrentFileName(QString currentFileName)
{
	_currentFileName = currentFileName;
	_fileNameTextBox->setText(_currentFileName);
}

void BackstageOSFOld::setMode(FileEvent::FileMode mode)
{
...
void BackstageOSFOld::openSaveFile(const QString &nodePath, const QString &filename)
{
...
void BackstageOSFOld::userDetailsReceived()
{
...
void BackstageOSFOld::openSaveCompleted(FileEvent* event)
{
...
void BackstageOSFOld::updateUserDetails()
{
...
void BackstageOSFOld::newFolderCreated()
{
...
void BackstageOSFOld::newFolderClicked()
{
	FSBMOSF::OnlineNodeData currentNodeData = _model->currentNodeData();
...
void BackstageOSFOld::authenticatedHandler()
{
	_newFolderButton->setEnabled(true);
	_logoutButton->show();
}

void BackstageOSFOld::logoutClicked()
{
...
bool BackstageOSFOld::checkEntryName(QString name, QString entryTitle, bool allowFullStop)
{
	if (name.trimmed() == "")
	{
