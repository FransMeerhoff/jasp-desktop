...
isEmpty(MODULE_NAME) {
	...
	win32{
		...
		#Update QML-$${MODULE_NAME}.pot file
		...
		#Cleanup QML-$${MODULE_NAME}.pot file
		...
		for(LANGUAGE_CODE, SUPPORTED_LANGUAGES) {
			...
			!exists($${WIN_MODULE_LOCATION}\po\R-$${LANGUAGE_CODE}.po){
				GenerateLanguageFiles$${MODULE_NAME}.commands += $$quote(echo "INITIALIZE R-TRANSLATION-FILES WITH MSGMERGE: $${LANGUAGE_CODE}") &&
			...
			!exists($${WIN_MODULE_LOCATION}\po\R-$${LANGUAGE_CODE}.po){
				GenerateLanguageFiles$${MODULE_NAME}.commands += $$quote(echo "INITIALIZE QML-TRANSLATION-FILES WITH MSGMERGE: $${LANGUAGE_CODE}") &&
	...
	unix{
		...
		for(LANGUAGE_CODE, SUPPORTED_LANGUAGES) {
			...
			!exists($$PWD/$${MODULE_NAME}/po/R-$${LANGUAGE_CODE}.po){
				...
				GenerateLanguageFiles$${MODULE_NAME}.commands +=  msgmerge $$PWD/../Engine/jaspBase/po/R-$${LANGUAGE_CODE}.po $$PWD/$${MODULE_NAME}/po/R-$${MODULE_NAME}.pot > $$PWD/$${MODULE_NAME}/po/R-$${LANGUAGE_CODE}.po ;
